...
wallet directory. Grant access to Ultracoind.exe in anti-virus and firewall
...
Ultracoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Ultracoind stop
Start up the new Ultracoind (0.3.0).
